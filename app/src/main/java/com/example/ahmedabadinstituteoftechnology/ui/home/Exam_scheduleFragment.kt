 ...
 * Use the [Exam_scheduleFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class Exam_scheduleFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment Exam_scheduleFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Exam_scheduleFragment().apply {
